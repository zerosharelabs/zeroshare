    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "border bg-neutral-925 text-neutral-400 border-neutral-800 p-1",
          className
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-neutral-300 gap-2 py-1.5 pr-8 pl-2 text-sm",
        "hover:bg-neutral-800 hover:text-neutral-300",
        "data-[state=checked]:text-neutral-200 font-normal cursor-pointer",
        variant === "destructive" &&
          "text-red-400 hover:bg-red-950 hover:text-red-400",
        className
      )}
      {...props}
    />
